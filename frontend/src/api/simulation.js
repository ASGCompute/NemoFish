...
/**
 * Real-time fetch of generating Agent Profiles
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Real-time fetch of generating simulation config
 * @param {string} simulationId
...
/**
 * Get simulation runtime detailed status (with recent actions)
 * @param {string} simulationId
 */
...
/**
 * Shutdown simulation environment (graceful exit)
