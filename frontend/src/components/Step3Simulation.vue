...
const doStartSimulation = async () => {
  ...
  // Reset all state to avoid interference from previous simulation
  resetAllState()
...
const checkPlatformsCompleted = (data) => {
  ...
  // No platforms enabled, return false
...
const fetchRunStatusDetail = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      // Get full action list from all_actions
