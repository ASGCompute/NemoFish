          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick conversation with the report agent. Has access to 4 professional tools and MiroFish's complete memory.</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-based BFS algorithm that reconstructs event propagation paths and captures full topology of information flow</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewing agent that conducts parallel multi-round dialogues with simulated individuals, collecting unstructured viewpoint data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Select Conversation Partner: ${agent.username}`)
}
...
const renderMarkdown = (content) => {
  ...
  // Clean before/after block elements <br> tags
  ...
  // Clean before paragraph open tags following block elements <br>
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix non-consecutive ordered list numbering: maintain incrementing numbers when single <ol> items are separated by paragraph content
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    // Format: {"twitter_0": {...}, "reddit_0": {...}} or single platform
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData
    
    // Convert object dict to array, prioritize reddit platform replies
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prioritize reddit replies, then twitter
...
const submitSurvey = async () => {
  ...
  try {
    ...
    addLog(`Survey sending failed: ${err.message}`)
  } finally {
