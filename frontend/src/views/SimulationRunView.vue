...
// Get maxRounds from query params at init to ensure child components get it immediately
...
const handleGoBack = async () => {
  ...
  try {
    // First try gracefully shutting down simulation
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh doesn't show fullscreen loading to avoid flicker
