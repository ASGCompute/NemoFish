 ...
 * When user returns from Step 3 to Step 2, assume they want to exit
 */
const checkAndStopRunningSimulation = async () => {
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      // Environment not running, but process might be, check sim status
    ...
    // Checking env status failure doesn't block later logic
